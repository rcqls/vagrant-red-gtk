...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision :shell, :inline => <<-SHELL
    ...
    apt-get install -y libc6 libcurl xorg openbox
    apt-get install -y libgtk-3-bin librsvg2-common libcanberra-gtk-module  libcanberra-gtk3-module  at-spi2-core 
